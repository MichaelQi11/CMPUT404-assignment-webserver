...
# Copyright 2021 Hongru Qi

# This code is assignment from class CMPUT 404 from University of 
# Alberta assigned by Dr. Abram Hindle.
...
class MyWebServer(socketserver.BaseRequestHandler):
    ...
    def handle(self):
        ...
        # The method to get request url and response strucure are stolen from 成西风, https://blog.csdn.net/weixin_29609679
        # From CSDN
